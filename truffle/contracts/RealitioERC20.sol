...
contract RealitioERC20 is BalanceHolder {
    ...
    constructor() 
    public {
        createTemplate('{"title": "%s", "type": "bool", "category": "%s", "lang": "%s", "description": "%s"}');
        createTemplate('{"title": "%s", "type": "uint", "decimals": 18, "category": "%s", "lang": "%s", "description": "%s"}');
        createTemplate('{"title": "%s", "type": "single-select", "outcomes": [%s], "category": "%s", "lang": "%s", "description": "%s"}');
        createTemplate('{"title": "%s", "type": "multiple-select", "outcomes": [%s], "category": "%s", "lang": "%s", "description": "%s"}');
        createTemplate('{"title": "%s", "type": "datetime", "category": "%s", "lang": "%s", "description": "%s"}');
    }
