...
if ((token_name != 'ETH' && token_address == undef) && (task != 'ERC20')) {
...
function deployRealitio(is_erc20) {
    const tmpl = is_erc20 ? 'RealitioERC20' : 'Realitio';
